...
useEffect(()=>{
  Axios.get('http://localhost:5000/admindashboard').then((response)=>{
 ...
 const approveApplication=(id)=>{
  console.log(id);
Axios.post('http://localhost:5000/approveApplication/'+id)
.then((res)=>{
 ...
 const rejectApplication=(id)=>{
  console.log(id);
Axios.post('http://localhost:5000/rejectApplication/'+id)
.then((res)=>{
  navigate("/admindashboard")
})   
 }
...
<h1 className='pl-2 text-2xl'>Pending Applications</h1>
